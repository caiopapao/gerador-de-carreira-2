...
const mensagemNivel1 = `Sua missão é: escolher o time ${timesElites[timeEliteAleatorio]} e conseguir ${missoesElite[missaoEliteAleatoria]}, porém ${complicadoresElite[complicadorEliteAleatorio]}. `

const nivel1Completo = document.querySelector('.nivel-1')

nivel1Completo.addEventListener('click',()=>{
    document.write(mensagemNivel1)
})




const mensagemNivel2= 'Em breve !!!!'
const nivel2Completo = document.querySelector('.nivel-2')

nivel2Completo.addEventListener('click',()=>{
    document.write(mensagemNivel2)
})

const mensagemNivel3= 'Em breve !!!!'
const nivel3Completo = document.querySelector('.nivel-3')

nivel3Completo.addEventListener('click',()=>{
    document.write(mensagemNivel3)
})
